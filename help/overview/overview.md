...
<td><a href="../start/experiment-accelerator-access.md"><img width="70%" alt="Aan de slag" src="../assets/do-not-localize/a-b-test.png"></a><br/><a href="../start/experiment-accelerator-access.md">Aan de slag met de Journey Optimizer Experimentation Accelerator</a></td>
<td><a href="../start/experiment-accelerator-best-practices.md"><img width="70%" alt="best practices" src="../assets/do-not-localize/best-practices.png"></a><br/><a href="../start/experiment-accelerator-best-practices.md">Aanbevolen procedures voor Journey Optimizer Experimentation Accelerator</a></td>
<td><a href="../track/experiment-accelerator-monitor.md"><img width="70%" alt="track" src="../assets/do-not-localize/track.png"></a></br><a href="../track/experiment-accelerator-monitor.md">De prestaties van uw experimenten volgen en bewaken</a></td>
</tr>
</table>
